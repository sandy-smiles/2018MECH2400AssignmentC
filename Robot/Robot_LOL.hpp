...
void setup() {
  ...
  */
  ...
  Drive_Time_Command *drive_cmd02 = new Drive_Time_Command(driveSubsystem, turn_left, 2250, 15); // Rotate 90 anti-clockwise
  ...
  Drive_Time_Command *drive_cmd03 = new Drive_Time_Command(driveSubsystem, forwards, 2000, 15); // Move forward 250mm
  ...
  Drive_Time_Command *drive_cmd05 = new Drive_Time_Command(driveSubsystem, right, 450, 15);// Move right 69.5mm
  ...
  Lift_Time_Command *lift_cmd03 = new Lift_Time_Command(liftSubsystem, up, 1000, 90); // Lift up until max
  ...
  Lift_Time_Command *lift_cmd05 = new Lift_Time_Command(liftSubsystem, down, 9000, 90); // Lift down (max 150mm from base)
  ...
  Drive_Time_Command *drive_cmd14 = new Drive_Time_Command(driveSubsystem, left, 3268, 15); // Move left 196mm
